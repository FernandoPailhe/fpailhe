...
export function SealMark({ icon = "✦", monogram = "APP" }: SealMarkProps) {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle at 32% 26%, rgba(255,255,255,.14), rgba(255,255,255,0) 45%)",
    ...
    >
      ...
      <span className="font-mono text-[0.56rem] font-bold tracking-[0.12em] text-gold-bright">
        {monogram}
      </span>
    </div>
  );
